...
exports.getProfiles = catchAsync(async (req, res, next) => {
    ...
    const profiles = await Profile.find({}).limit(2);
...
exports.acceptRequest = catchAsync(async (req, res, next) => {
    ...
    const updateUser = await Profile.findByIdUpdate(req.body.id, {
...
exports.getNotifiation = catchAsync(async(req, res, next) => {
